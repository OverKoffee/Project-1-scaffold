...
REVIEW:
Front card text appears with the sentence containing word to be learned - the user will decide if they understand it or don't - if user chooses "Good", the card is removed from review stack - if user chooses "Bad", the card is returns to the review stack
